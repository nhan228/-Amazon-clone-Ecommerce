...
export const receiptApi =  {
    ...
    addToCart: async (item: any) => {
        return await axios.post(`${import.meta.env.VITE_SERVER}/api/${version}/${prefix}/add-to-cart`, item)
    },
    ...
    updateReceipt: async (receiptId: number, data: any) => {
        return await axios.patch(`${import.meta.env.VITE_SERVER}/api/${version}/${prefix}/updateReceipt/${receiptId}`, data)
    },
