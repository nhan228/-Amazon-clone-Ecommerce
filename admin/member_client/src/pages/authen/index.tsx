...
import './member-authen.scss'
import { useState } from 'react'
import { Modal, message } from 'antd'
import BtnLoading from '@/components/BtnLoading'
import api from '@services/apis'

export default function MemberAuthen() {
    const [load, setLoad] = useState<boolean>(false)

    const handleLogin = async (e: React.FormEvent) => {
        e.preventDefault();
        try {
            const loginId = (e.target as any).loginId.value
            ...
            setLoad(true)
            let res = await api.memberApi.login(data);

            localStorage.setItem("tokenAdmin", res.data.tokenAdmin);
            message.success("Authentication successful, move to admin page in few second")
    ...
    return (
        <div className='body-authen-member'>
            <div className='box'>
                <div className="container">
                    ...
                    <div className="left">
                        {load && <BtnLoading />}
                        {/* LOGO */}
                        <img className='amazon-logo' src={pictures.adminAuthenLogo} alt="member-login-logo" />

                        {/* FORM */}
                        <form className="form" onSubmit={handleLogin}>
                            {/* title */}
                            <div className='member-form-title'>LOGIN</div>

                            {/* loginID */}
                            <div className="input-block">
                                <input className="input-text" type="text" id="loginId" name='loginId' autoFocus required />
                                <label htmlFor="loginId">Username or email</label>
                            </div>

                            {/* password */}
                            <div className="input-block">
                                <input className="input-text" type="password" id="password" name='password' required />
                                <label htmlFor="password">Password</label>
                            </div>

                            {/* submit button */}
                            <div className="input-block">
                                <button type='submit' className='member-btn-form'>Continue</button>
                            </div>
                        </form>
                    </div>
